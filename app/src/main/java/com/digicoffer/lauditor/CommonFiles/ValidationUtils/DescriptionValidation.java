...
public class DescriptionValidation implements TextWatcher {

    private EditText editText;

    public DescriptionValidation(EditText editText) {
    ...
    public void afterTextChanged(Editable editable) {
        ...
        cleanInput = cleanInput.replaceAll("[^a-zA-Z0-9!@#$%^&*()_+\\-=\\[\\];':\"|,.<>?/~` \\n]", "");

        if (!cleanInput.equals(editable.toString())) {
