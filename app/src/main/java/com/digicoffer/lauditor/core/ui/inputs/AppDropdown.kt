...
import com.digicoffer.lauditor.core.ui.models.DropdownItem
...
@Preview(showBackground = true, name = "AppDropdown Multi Select Preview")
@Composable
fun AppDropdownMultiPreview() {
    val options = listOf("Client A", "Client B", "Client C")
    LauditorTheme {
        AppDropdown(
            options = options,
            selectedOption = null,
            onOptionSelected = {},
            isMultiSelect = true,
            selectedOptions = setOf("Client A", "Client B"),
